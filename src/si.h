...
struct SiDimensions
{
    ...
    using AngularMomentum  = Quantity<Engn, Dim<base_dimensions::Length, 2>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -1>>;
    using AngularSpeed = Quantity<Engn, Dim<base_dimensions::Time, -1>>;
    using Area  = Quantity<Engn, Dim<base_dimensions::Length, 2>>;
    using AreaDensity  = Quantity<Engn, Dim<base_dimensions::Length, -2>, Dim<base_dimensions::Mass, 1>>;
    using Capacitance  = Quantity<Engn, Dim<base_dimensions::Length, -2>, Dim<base_dimensions::Mass, -1>, Dim<base_dimensions::Time, 4>, Dim<base_dimensions::ElectricCurrent, 2>>;
    ...
    using ChemicalPotential  = Quantity<Engn, Dim<base_dimensions::Length, 2>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -2>, Dim<base_dimensions::AmountOfSubstance, -1>>;
    ...
    using DynamicViscosity  = Quantity<Engn, Dim<base_dimensions::Length, -1>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -1>>;
    ...
    using ElectricFieldStrength  = Quantity<Engn, Dim<base_dimensions::Length, 1>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -3>, Dim<base_dimensions::ElectricCurrent, -1>>;
    using ElectricalConductance  = Quantity<Engn, Dim<base_dimensions::Length, -2>, Dim<base_dimensions::Mass, -1>, Dim<base_dimensions::Time, 3>, Dim<base_dimensions::ElectricCurrent, 2>>;
    using ElectricalConductivity  = Quantity<Engn, Dim<base_dimensions::Length, -3>, Dim<base_dimensions::Mass, -1>, Dim<base_dimensions::Time, 3>, Dim<base_dimensions::ElectricCurrent, 2>>;
    using ElectricPotential  = Quantity<Engn, Dim<base_dimensions::Length, 2>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -3>, Dim<base_dimensions::ElectricCurrent, -1>>;
    using ElectricalResistance  = Quantity<Engn, Dim<base_dimensions::Length, 2>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -3>, Dim<base_dimensions::ElectricCurrent, -2>>;
    using ElectricalResistivity  = Quantity<Engn, Dim<base_dimensions::Length, 3>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -3>, Dim<base_dimensions::ElectricCurrent, -2>>;
    using Energy  = Quantity<Engn, Dim<base_dimensions::Length, 2>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -2>>;
    using EnergyDensity  = Quantity<Engn, Dim<base_dimensions::Length, -1>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -2>>;
    using Entropy  = Quantity<Engn, Dim<base_dimensions::Length, 2>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -2>, Dim<base_dimensions::Temperature, -1>>;
    using Force  = Quantity<Engn, Dim<base_dimensions::Length, 1>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -2>>;
    ...
    using Heat  = Quantity<Engn, Dim<base_dimensions::Length, 2>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -2>>;
    using HeatCapacity  = Quantity<Engn, Dim<base_dimensions::Length, 2>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -2>, Dim<base_dimensions::Temperature, -1>>;
    ...
    using Impedance  = Quantity<Engn, Dim<base_dimensions::Length, 2>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -3>, Dim<base_dimensions::ElectricCurrent, -2>>;
    using Impulse  = Quantity<Engn, Dim<base_dimensions::Length, 1>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -1>>;
    using Inductance  = Quantity<Engn, Dim<base_dimensions::Length, 2>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -2>, Dim<base_dimensions::ElectricCurrent, -2>>;
    ...
    using LinearDensity  = Quantity<Engn, Dim<base_dimensions::Length, -1>, Dim<base_dimensions::Mass, 1>>;
    ...
    using MagneticFlux  = Quantity<Engn, Dim<base_dimensions::Length, 2>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -2>, Dim<base_dimensions::ElectricCurrent, -1>>;
    ...
    using MassDensity  = Quantity<Engn, Dim<base_dimensions::Length, -3>, Dim<base_dimensions::Mass, 1>>;
    ...
    using MolarEnergy  = Quantity<Engn, Dim<base_dimensions::Length, 2>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -2>, Dim<base_dimensions::AmountOfSubstance, -1>>;
    using MolarEntropy  = Quantity<Engn, Dim<base_dimensions::Length, 2>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -2>, Dim<base_dimensions::Temperature, -1>,  Dim<base_dimensions::AmountOfSubstance, -1>>;
    using MolarHeatCapacity  = Quantity<Engn, Dim<base_dimensions::Length, 2>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -2>, Dim<base_dimensions::Temperature, -1>,  Dim<base_dimensions::AmountOfSubstance, -1>>;
    using MomentOfInertia  = Quantity<Engn, Dim<base_dimensions::Length, 2>, Dim<base_dimensions::Mass, 1>>;
    using Momentum  = Quantity<Engn, Dim<base_dimensions::Length, 1>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -1>>;
    using Permeability  = Quantity<Engn, Dim<base_dimensions::Length, 1>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -2>, Dim<base_dimensions::ElectricCurrent, -2>>;
    using Permittivity  = Quantity<Engn, Dim<base_dimensions::Length, -3>, Dim<base_dimensions::Mass, -1>, Dim<base_dimensions::Time, 4>, Dim<base_dimensions::ElectricCurrent, 2>>;
    using Power  = Quantity<Engn, Dim<base_dimensions::Length, 2>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -3>>;
    using Pressure  = Quantity<Engn, Dim<base_dimensions::Length, -1>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -2>>;
    ...
    using RadiantIntensity  = Quantity<Engn, Dim<base_dimensions::Length, 2>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -3>>;
    ...
    using Reluctance  = Quantity<Engn, Dim<base_dimensions::Length, -2>, Dim<base_dimensions::Mass, -1>, Dim<base_dimensions::Time, 2>, Dim<base_dimensions::ElectricCurrent, 2>>;
    ...
    using SpecificVolume  = Quantity<Engn, Dim<base_dimensions::Length, 3>, Dim<base_dimensions::Mass, -1>>;
    using Spin  = Quantity<Engn, Dim<base_dimensions::Length, 2>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -1>>;
    using Stress  = Quantity<Engn, Dim<base_dimensions::Length, -1>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -2>>;
    ...
    using ThermalConductivity  = Quantity<Engn, Dim<base_dimensions::Length, 1>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -3>, Dim<base_dimensions::Temperature, -1>>;
    using Torque  = Quantity<Engn, Dim<base_dimensions::Length, 2>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -2>>;
    ...
    using Weight  = Quantity<Engn, Dim<base_dimensions::Length, 1>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -2>>;
    using Work  = Quantity<Engn, Dim<base_dimensions::Length, 2>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -2>>;
    using YoungsModulus  = Quantity<Engn, Dim<base_dimensions::Length, -1>, Dim<base_dimensions::Mass, 1>, Dim<base_dimensions::Time, -2>>;
